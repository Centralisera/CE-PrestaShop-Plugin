...
class CENTRALISERAValidationModuleFrontController extends ModuleFrontController
{
	/**
	...
	**/
    ...
    
	{
		...
		if (!$authorized)
		{
			die($this->module->getTranslator()->trans('This payment method is not available.', array(), 'Modules.CENTRALISERA.Shop'));
		}
